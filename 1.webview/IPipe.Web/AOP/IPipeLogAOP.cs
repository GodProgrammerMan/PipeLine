...
namespace IPipe.Web.AOP
{
    /// <summary>
    /// 拦截器IPipeLogAOP 继承IInterceptor接口
    /// </summary>
    public class IPipeLogAOP : IInterceptor
    {
        private readonly IHubContext<ChatHub> _hubContext;
        private readonly IHttpContextAccessor _accessor;

        public IPipeLogAOP(IHubContext<ChatHub> hubContext, IHttpContextAccessor accessor)
        {
